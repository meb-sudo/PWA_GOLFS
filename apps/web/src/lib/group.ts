 ...
 * lien", il n est pas memorise. Une fois resolu, il est garde en memoire pour
 * etre envoye au BFF via l en-tete `X-Golf-Group` a chaque appel API (avant
 * connexion). Apres connexion, c est la session (cookie httpOnly) qui porte
 * le groupe cote serveur.
 */
